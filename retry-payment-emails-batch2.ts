...
// List of payment IDs that already had emails sent in the previous run
const processedPaymentIds = [20, 31, 34, 38, 41];

// This script finds completed payments that haven't had emails sent and resends them
async function retryPaymentEmails() {
  try {
    console.log('\n===============================');
    console.log('PAYMENT EMAIL RETRY UTILITY - BATCH 2');
    console.log('===============================');
    ...
    console.log(`Found ${unsentPayments.length} more completed payments that need email notifications`);
